...
class ConnectingLines extends StatefulWidget {
  ...
  @override
  State<ConnectingLines> createState() => _ConnectingLinesState();
}

class _ConnectingLinesState extends State<ConnectingLines>
  ...
  @override
  void didUpdateWidget(ConnectingLines oldWidget) {
      ...
      for (var j = i + 1; j < children.length; j++) {
        ...
        if (distance <= connectionRange) {
          ...
          if (shouldAnimate) {
            ...
            final animatedEnd =
                Offset.lerp(paddedStart, paddedEnd, animationProgress)!;
